...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <div class="row align-items-baseline">
            <h1>てんしる</h1>
            <div class="subtitle"><span class="d-none d-lg-inline">　〜</span>食品<span class="orange">添</span>加物について<span class="orange">知る</span>ことで<br class="d-lg-none">健康になろう<span class="d-none d-lg-inline">〜</span></div>
        </div>
        </div>
