...
@section('content')
    ...
    <div class="container">
        <h2>このサイトについて</h2>
        食品添加物の表示は、物質名で表示するもの、用途名と物質名を併記して表示するもの、用途名を表示するものがあります。
        こちらでは、その表示名を「添加物名」として紹介します。
        <p>よく使用されている「添加物名」を一覧としていますので、簡単に調べることが出来ます。</p>
        
        <p>危険度については、
        <p>危険度★☆☆：安全性の高いもの</p>
        <p>危険度★★☆：はっきりとした毒性は認められないが、安全師が高いとはいえないもの</p>
        <p>危険度★★★：避けた方が良いもの</p>
        となっています。</P>
        ...
        <p>食品添加物の安全性は人間で調べられたものではありません。動物実験の結果に基づいて、害はないだろうと推測しているだけです。</p>
        <p>また、動物実験で調べられるのは急性毒性、発がん性、催奇形成などの症状がはっきり分かるものだけですし、動物実験で毒性が認められたにも関わらず、添加物として使用が認められているものがあります。</p>
        
        <h3>このサイトを作った理由</h3>
        <p>現在がんを発病する日本人は２人に１人で、最も多いのが大腸がん、２番目が胃がんです。</p>
        <p>胃も大腸も食べ物が通過する臓器であり、発がんには加工食品に使われている添加物が関係していると考えられています。</p>
        
        <p>私は以前から食品添加物について興味を持っており、友人と食品添加物の危険性について話をすることがありました。</p>
        <p>その時に感じたのは、知識が少ないこと、本当は健康のために良い商品を選択したいと思っているということでした。</p>
        
        <p>そこで、食品添加物について知ってもらうことで、良い商品を選択できていない人々が多い社会を変えたいという想いで作りました。</p>
