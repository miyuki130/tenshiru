...
@section('content')
    ...
    <div class="container">
        ...
        また、動物実験で調べられるのは急性毒性、発がん性、催奇形成などの症状がはっきり分かるものだけですし、動物実験で毒性が認められたにも関わらず、添加物として使用が認められているものがあります。</p>
        ...
        私は以前から食品添加物について興味を持っており、友人と食品添加物の危険性について話をすることがありました。<br>
        <p>その時に感じたのは、知識が少ないこと、本当は健康のために良い商品を選択したいと思っているということでした。</p>
        
        そこで、食品添加物について知ってもらうことで、良い商品を選択できていない人々が多い社会を変えたいという想いでこのサイトを作りました。<br>
